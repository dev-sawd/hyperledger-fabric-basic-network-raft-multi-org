...
SK_NAME=$SK_NAME docker-compose -f docker-compose.yml up -d ca.org1.example.com ca.org2.example.com orderer.example.com peer0.org1.example.com couchdb cli peer1.org1.example.com orderer2.example.com orderer3.example.com peer0.org2.example.com peer1.org2.example.com
